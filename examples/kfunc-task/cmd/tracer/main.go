...
import (
	...
	"github.com/kyleseneker/tinybpf/examples/kfunc-task/internal/loader"
	"github.com/kyleseneker/tinybpf/examples/kfunc-task/internal/reader"
)

func main() {
	var objectPath string
	flag.StringVar(&objectPath, "object", "build/task.bpf.o", "Path to BPF object built by tinybpf.")
	flag.Parse()
